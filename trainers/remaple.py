...
'''
process and configs
txt --> shared dispatcher for all classes (new one for each laryer)
dispacher --> be projected to img branch as img dispacher
img --> sorted by dispacher
fixed rate for pruning or merging
'''
...
class MultiModalPromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        prompts = [prompt_prefix + " " + name + "." for name in classnames] # prompt = prompt_prefix ("a photo of ") + name ("cat/...")
    ...
    def forward(self):
        # ctx = self.compound_prompts_text[0]
        ...
        return self.txt_prompts, self.compound_prompts_text, visual_deep_prompts   # pass here original, as for visual 768 is required
