...
# base_path = '~/data1/zmm/output/base2new/train_base'
# trainer = '/ReMaPLe_3'
# scripts = '/vit_b16_c2_ep5_batch4_2ctx'
# seed = '/seed1'
# database = ['/caltech101', '/dtd', '']

# model_path = base_path + trainer + scripts + database[0] + seed
# name = 'MultiModalPromptLearner'
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.ReMAPLE.N_CTX = 1  # number of context vectors
